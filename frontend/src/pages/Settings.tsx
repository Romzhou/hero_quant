        ...
        <div className="mt-3 grid gap-3 md:grid-cols-2">
          <div className="rounded-xl border border-white/10 bg-ink-900/60 px-3 py-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <StatusDot ok={live.ok} />
              <span className="font-mono text-xs text-mist">{ENDPOINTS.LIVE}</span>
          ...
          <div className="rounded-xl border border-white/10 bg-ink-900/60 px-3 py-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <StatusDot ok={metrics.ok} />
              <span className="font-mono text-xs text-mist">{ENDPOINTS.METRICS}</span>
